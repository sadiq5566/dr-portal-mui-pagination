...
const DisableBmv: React.FC<IProps> = ({ setModal }) => {
  ...
  return (
    <Modal open={true}>
      <Box sx={style}>
        ...
        <Box sx={iconBox}>
          <Box sx={iconDiv}>
            <PersonOffIcon sx={{ color: theme.palette.error.main, fontSize: "40px" }} />
          </Box>
          <Box>
            <Typography variant="h4">Disable Owner?</Typography>
          </Box>
        </Box>
        <Box>
          <List
